...
export default function App() {
  // State to manage the visibility of the "Coming Soon" modal for the App Store.
  const [showAppStoreModal, setShowAppStoreModal] = useState(false)

  // Opens the App Store "Coming Soon" modal.
  const handleAppStoreClick = (e) => {
    e.preventDefault()
    setShowAppStoreModal(true)
  }

  // Closes the App Store modal.
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 transform transition-all duration-300 scale-100">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200">
              ...
              <button onClick={closeAppStoreModal} className="text-gray-400 hover:text-gray-600 transition-colors duration-200">
                <X className="h-6 w-6" />
              </button>
            </div>
            ...
            <div className="p-6 text-center">
              <div className="mb-4">
                ...
                <h4 className="text-lg font-semibold text-gray-900 mb-2">Apple App Store</h4>
                <p className="text-gray-600 mb-6">
                  We're working hard to bring Numbr to the App Store. Our app will be available soon!
                </p>
              </div>
