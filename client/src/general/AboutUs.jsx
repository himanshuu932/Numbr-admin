...
export default function AboutUs() {
  ...
  return (
    ...
    >
      {/* Geometric background shapes with light effects - similar to ContactUs */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        {/* Top left triangle */}
        <div className="absolute top-0 left-0 w-0 h-0 border-l-[200px] border-l-blue-900 border-b-[150px] border-b-transparent opacity-90 hover:scale-110 transition-all duration-700 ease-out group">
        ...
        <div className="absolute top-0 right-0 w-64 h-32 bg-blue-900 opacity-90 rounded-bl-[100px] hover:rounded-bl-[150px] transition-all duration-1000 ease-in-out group overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-0 h-0 border-r-[250px] border-r-blue-900 border-t-[200px] border-t-transparent opacity-90 hover:scale-110 transition-all duration-700 ease-out group">
        ...
        <div className="absolute bottom-0 left-0 w-48 h-24 bg-blue-900 opacity-80 rounded-tr-[80px] hover:rounded-tr-[120px] transition-all duration-1000 ease-in-out group overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full z-0">
        ...
        <div className="absolute top-[20%] right-[15%] grid grid-cols-7 gap-2 opacity-60 group">
          {Array.from({ length: 28 }).map((_, i) => (
            <div
              key={i}
              className="relative w-2 h-2 text-blue-900 font-bold text-xs flex items-center justify-center hover:text-white hover:scale-150 hover:rotate-45 transition-all duration-300 group-hover:animate-pulse"
        ...
        <div className="absolute bottom-[25%] left-[10%] grid grid-cols-7 gap-2 opacity-60 group">
          {Array.from({ length: 28 }).map((_, i) => (
            <div
              key={i}
              className="relative w-2 h-2 text-blue-900 font-bold text-xs flex items-center justify-center hover:text-white hover:scale-150 hover:-rotate-45 transition-all duration-300 group-hover:animate-bounce"
        ...
        {/* Circular accents */}
        <div className="absolute top-[60%] left-[20%] w-8 h-8 rounded-full bg-blue-900/50 hover:scale-150 hover:bg-blue-900/80 transition-all duration-500 group">
        ...
        <div className="absolute top-[30%] right-[25%] w-6 h-6 rounded-full bg-blue-900/40 hover:scale-150 hover:bg-blue-900/70 transition-all duration-700 group">
      ...
      >
        ...
        <div className="relative w-full flex flex-col items-center space-y-8">
          ...
          <div className="grid grid-cols-2 gap-6 w-full mt-6">
            {/* Team */}
            <div className="bg-blue-900/10 p-4 rounded-xl hover:bg-blue-900/20 transition-all duration-300 group">
