    ...
    <div className="app-container">
      ...
      <footer className="app-footer">
        <nav className="footer-nav">
            <button onClick={() => setActiveView('terms')} className="footer-link">Terms and Conditions</button>
            <button onClick={() => setActiveView('privacy')} className="footer-link">Privacy Policy</button>
            <button onClick={() => setActiveView('cancellation')} className="footer-link">Cancellation and Refund Policy</button>
        </nav>
        <p>&copy; 2024 Barbers App Developer Panel. All rights reserved.</p>
      </footer>
    </div>
  );
}
